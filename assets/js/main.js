...
const appendMessage = (container, text, cssClass) => {
...
const setupIndexChatPanel = () => {
    const chatBtn = document.querySelector(".chat-panel-btn");
    const chatPanel = document.querySelector(".chat-panel-inner");
    const chatExpanded = document.querySelector(".chat-expanded");
    const chatInput = document.querySelector(".chat-input");
    const chatMessages = document.querySelector(".chat-messages");
    const chatForm = chatExpanded?.querySelector(".chat-form");
    if (!chatBtn ||
        !chatPanel ||
        !chatExpanded ||
        !chatInput ||
    ...
    const sendMessage = () => {
        ...
        setTimeout(() => {
            appendMessage(chatMessages, "🍑 Thanks for your message! (This is a demo reply.)", "bot");
        }, 500);
    };
    ...
    const closeBtn = chatExpanded.querySelector(".chat-close-a");
    if (closeBtn) {
...
const setupHeroChatPanel = () => {
    const chatCTA = document.querySelector(".chat-cta__button");
    const hero = document.querySelector(".hero--peach");
    const chatPanel = document.querySelector(".chat-panel--hero");
    ...
    const chatMessages = chatPanel.querySelector(".chat-panel__messages");
    const openChat = () => {
...
const setupConceptCChatPanel = () => {
    ...
    const chatButton = document.querySelector(".chat-button-c");
    const chatPanel = document.querySelector(".chat-panel--concept-c");
    const heroTitle = document.querySelector(".hero-banner-text");
...
const setupIdentityBadgesEditorial = () => {
    const badges = document.querySelectorAll(".identity-badge");
    ...
    const contentMap = {
        living: {
            title: "Living Here",
            summary: "Daily life in Perry is shaped by safety, reliable services, and the natural beauty of the Wasatch Front.",
            links: [
                "Utilities & Billing",
                "Public Safety",
                "Parks & Recreation",
        ...
        community: {
            ...
            summary: "Perry is a place where neighbors wave from their porches and community events still feel like family gatherings.",
            links: [
                "Community Events",
                "Parks & Trails",
                "Youth Programs",
        ...
        perfecting: {
            ...
            summary: "Perry is planning thoughtfully for the future — supporting local businesses, improving infrastructure, and guiding development with care.",
            links: [
